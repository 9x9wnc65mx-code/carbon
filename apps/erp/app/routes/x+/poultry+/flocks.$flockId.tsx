...
export async function action({ request, params }: ActionFunctionArgs) {
  ...
  if (intent === "updateFlock") {
    ...
    throw redirect(
      `/x/poultry/flocks/${params.flockId}`,
  ...
  if (intent === "assignVaccinationProgram") {
    ...
    throw redirect(
      `/x/poultry/flocks/${params.flockId}`,
      await flash(request, success("Vaccination program assigned and schedule generated"))
    );
  }
          ...
          <Card className="w-full">
            ...
            <CardContent>
              <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                ...
                <PassportItem label={<Trans>Health & vaccination</Trans>}><span className="text-emerald-600"><Trans>Vaccination workflow active</Trans></span></PassportItem>
